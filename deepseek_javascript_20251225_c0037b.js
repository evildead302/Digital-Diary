...
function updateDriveUI() {
    ...
    document.getElementById('gdriveClientId').value = config.clientId || '';
    document.getElementById('gdriveApiKey').value = config.apiKey || '';
    document.getElementById('gdriveFolderId').value = config.folderId || '';
    ...
    if (!window.driveSync) {
        if (statusElement) statusElement.innerHTML = '<span style="color: #f44336;">❌ Drive sync not loaded</span>';
        return;
    }
